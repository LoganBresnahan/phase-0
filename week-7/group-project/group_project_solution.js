...
2. As a user, I want to do an action that takes three different guidelines. 
   Some kind of test, a message I can send, and a number to list the number of tests I do.

3. As a user, I want to see if my test is legal or illegal. If my test is illegal I want to 
...
4. As a user, I want to be able to do my action I created with the guidelines. I want to run
   the action 9 times with different guidelines.  
 
5. As a user, I want my first action to test if the total sum is a viable action, or in other words, will the total
...
6. As a user, I want to test if the total sum of the odd amount of numbers list is equal to 27, I want
...
7. As a user, I want to test if the total sum of the even amount of numbers list is equal to 43, I want
...
8. As a user, I want to test if the mean is a viable action, or in other words, will the mean
...
9. As a user, I want to test if the mean of the odd amount of numbers list is equal to 3.857142857142857
...
10. As a user, I want to test if the mean of the even amount of numbers list is equal to 5.375
...
11. As a user, I want to test if the median is a viable action, or in other words, will the median
...
12. As a user, I want to test if the median of the odd amount of numbers list is equal to 4.
...
13. As a user, I want to test if the median of the even amount of numbers list is equal to 5.5.
